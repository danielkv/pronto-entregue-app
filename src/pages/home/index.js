...
import { Container, ImageLogo, Footer, HeaderContainer, CategoriesContainer, Categories, FeaturedProductContainer, FeaturedProductTitle, FeaturedProductSubtitle, CategoriesTitle, Category, CategoryImage, CategoryTitle } from './styles';
...
export default function Home({navigation}) {
	...
	const renderCategory = ({item:{id, name, image}}) => {
		return (
			<Category onPress={()=>{navigation.navigate('CategoryScreen')}}>
	...
	<Container>
		...
		<Footer>
			<ImageLogo source={require('../../assets/images/logo-copeiro.png')} />
		</Footer>
